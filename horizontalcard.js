export const createHorizontalProductCard = (products, parentElement,isinfav) => {
    for (let product of products) {
      ...
      incBtn.innerText = "+";
      incBtn.setAttribute("data-key", product._id);
      incBtn.setAttribute("data-name","add");
      const value = document.createElement("span");
      value.classList.add("count-value");
      let cnt=JSON.parse(localStorage.getItem(product._id))||1;
      value.innerText = cnt;
     
      const decBtn = document.createElement("button");
      decBtn.setAttribute("data-key", product._id);
      decBtn.setAttribute("data-name","dec");
